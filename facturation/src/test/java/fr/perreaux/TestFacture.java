...
class TestFacture {
    ...
    @Test
    void testAjouterProduitRetourneLeNbProduitDifferent() {
        // average
        ...
        assertEquals(3, res, "probleme attention");
    }

    @Test
    void testAjouterProduitRetourneLeNbProduitDifferentAvecAjoutProduitIdentique() {
        // average

        CategoryProduits tva = new CategoryProduits("electro", 20);
        int prixHT = 100;
        Produit p = new Produit("1machineLav1", "machine à laver", prixHT, tva);
        LigneFacture ligneProduit = new LigneFacture(1, p);
        Facture facture = new Facture(1, LocalDate.now());
        facture.ajouterProduit(ligneProduit);
        facture.ajouterProduit(ligneProduit);
        facture.ajouterProduit(ligneProduit);
